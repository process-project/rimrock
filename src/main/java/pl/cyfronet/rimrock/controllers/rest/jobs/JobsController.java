...
public class JobsController {
	...
	public ResponseEntity<SubmitResponse> submit(@Valid @RequestBody SubmitRequest submitRequest, BindingResult errors) {
	...
	public ResponseEntity<OutputResponse> output(@PathVariable String jobId) {
